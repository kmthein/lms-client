        ...
        <div className=" h-[200px]">
          ...
          <div className=" w-full bg-white rounded-md">
            <div className="slider-container max-w-full pt-3 pb-2">
              <Slider {...settings}>
                <div>
                  <img src="https://www.adobe.com/express/create/cover/media_19d5e212dbe8553614c3a9fbabd4d7f219ab01c85.png?width=750&format=png&optimize=medium" alt="img" className=" h-[180px] w-[130px]" />
                </div>
                <div>
                  <img src="https://www.adobe.com/express/create/cover/media_19d5e212dbe8553614c3a9fbabd4d7f219ab01c85.png?width=750&format=png&optimize=medium" alt="img" className=" h-[180px] w-[130px]" />
                </div>
            ...
            <div className="max-w-full pt-3 pb-2">
              <div className="flex gap-10 flex-wrap w-[100%] overflow-x-hidden">
                <div className=" bg-white w-[160px] px-4 pt-4 rounded-md">
                  <img src="https://marketplace.canva.com/EAFaQMYuZbo/1/0/1003w/canva-brown-rusty-mystery-novel-book-cover-hG1QhA7BiBU.jpg" alt="img" className=" h-[180px] w-[130px] rounded-sm mb-2" />
